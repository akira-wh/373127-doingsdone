...
<body><!--class="overlay"-->
      ...
      <header class="main-header">
        ...
        <div class="main-header__side">
          <a class="main-header__side-item button button--plus open-modal"
              href="javascript:;" target="task_add">
            Добавить задачу
          </a>
      ...
      <div class="content">
        <section class="content__side">
          ...
          <a class="button button--transparent button--plus content__side-button open-modal"
             href="javascript:;" target="project_add">
               Добавить проект
          </a>
        </section>
  ...
  <footer class="main-footer">
    <div class="container">
      ...
      <a class="main-footer__button button button--plus open-modal"
          target="task_add" href="javascript:;">
           Добавить задачу
      </a>
      ...
      <div class="main-footer__social social">
        ...
        <a class="social__link social__link--facebook" href="#">Facebook
          <svg width="27" height="27" viewBox="0 0 27 27" xmlns="http://www.w3.org/2000/svg">
            <circle stroke="#879296" fill="none" cx="13.5" cy="13.5" r="12.667"/><path fill="#879296" d="M14.26 20.983h-2.816v-6.626H10.04v-2.28h1.404v-1.364c0-1.862.79-2.922 3.04-2.922h1.87v2.28h-1.17c-.876 0-.972.322-.972.916v1.14h2.212l-.245 2.28h-1.92v6.625z"/>
          </svg>
        </a>
